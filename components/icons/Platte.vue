<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M24 44c5.96 0 2.336-8.864 6-13 3.126-3.53 14-1.914 14-7 0-11.046-8.954-20-20-20S4 12.954 4 24s8.954 20 20 20Z"/><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M28 17a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-12 4a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm1 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/></g>
  </svg>
</template>
...
export default class Platte extends Vue.with(Props) {
