<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><rect stroke-linejoin="round" stroke-width="4" stroke="#fff" rx="2" height="22" width="36" y="22" x="6"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M14 22v-8c0-5.523 4.477-10 10-10s10 4.477 10 10v8m-10 8v6"/></g>
  </svg>
</template>
...
export default class Lock extends Vue.with(Props) {
