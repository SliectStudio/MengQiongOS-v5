<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="M42 24H6m24-12 12 12-12 12"/></g>
  </svg>
</template>
...
export default class ArrowRight extends Vue.with(Props) {
