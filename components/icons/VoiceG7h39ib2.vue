<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><rect stroke-linejoin="round" stroke-width="4" stroke="#fff" rx="7" height="27" width="14" y="4" x="17"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M9 23c0 8.284 6.716 15 15 15 8.284 0 15-6.716 15-15M24 38v6"/></g>
  </svg>
</template>
...
export default class VoiceG7h39ib2 extends Vue.with(Props) {
