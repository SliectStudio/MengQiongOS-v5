<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m12 13 22 21-11 10V4l11 10-22 21"/></g>
  </svg>
</template>
...
export default class Bluetooth extends Vue.with(Props) {
