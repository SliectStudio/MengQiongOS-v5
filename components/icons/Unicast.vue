<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-width="4" stroke="#fff" d="M24 15a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z"/><path stroke-linecap="round" stroke-width="4" stroke="#fff" d="M24 15v8"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M18 33V23l6 .003"/><path stroke-linecap="round" stroke-width="4" stroke="#fff" d="M41 41v1M7 41v1m11-1v1m12-1v1"/></g>
  </svg>
</template>
...
export default class Unicast extends Vue.with(Props) {
