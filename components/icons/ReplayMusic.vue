<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#000" d="M21 24v-6l5 3 5 3-5 3-5 3v-6Z"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="M11.272 36.728A17.943 17.943 0 0 0 24 42c9.941 0 18-8.059 18-18S33.941 6 24 6c-4.97 0-9.47 2.015-12.728 5.272C9.614 12.93 6 17 6 17"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="M6 9v8h8"/></g>
  </svg>
</template>
...
export default class ReplayMusic extends Vue.with(Props) {
