<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#000" d="M6 9.256 24.009 4 42 9.256v10.778A26.316 26.316 0 0 1 24.003 45 26.32 26.32 0 0 1 6 20.029V9.256Z"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="m15 23 7 7 12-12"/></g>
  </svg>
</template>
...
export default class Protect extends Vue.with(Props) {
