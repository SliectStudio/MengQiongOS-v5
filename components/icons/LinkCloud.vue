<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M13 33c-3.333 0-9-1.5-9-7.5 0-7 7-8.5 9-8.5 1-3.5 3-9 11-9 7 0 10 4 11 7.5 0 0 9 1 9 9.5 0 6-5 8-9 8H22"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m27 28-5 5 5 5"/></g>
  </svg>
</template>
...
export default class LinkCloud extends Vue.with(Props) {
