<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><rect stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" rx="3" height="36" width="36" y="6" x="6"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M14 14h20v20H14zm20 9L23 34m2-20L14 25m20-11L14 34"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M14 22v12h12m-4-20h12v12"/></g>
  </svg>
</template>
...
export default class Fill extends Vue.with(Props) {
