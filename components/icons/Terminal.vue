<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><rect stroke-linejoin="round" stroke-width="4" stroke="#fff" rx="2" height="32" width="40" y="8" x="4"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m12 18 7 6-7 6m11 2h13"/></g>
  </svg>
</template>
...
export default class Terminal extends Vue.with(Props) {
