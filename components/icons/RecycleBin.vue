<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m16 18 8-13.5L32 18m6 10.5L46 42H30m-12.309-.322-15.69.178L10 28"/><path stroke-linecap="round" stroke-width="4" stroke="#fff" d="M17 29h13.822"/></g>
  </svg>
</template>
...
export default class RecycleBin extends Vue.with(Props) {
