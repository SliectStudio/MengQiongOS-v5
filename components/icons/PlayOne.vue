<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M15 24V11.876l10.5 6.062L36 24l-10.5 6.062L15 36.124V24Z"/></g>
  </svg>
</template>
...
export default class PlayOne extends Vue.with(Props) {
