<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m24.06 10-.036 28M10 24h28"/></g>
  </svg>
</template>
...
export default class Plus extends Vue.with(Props) {
