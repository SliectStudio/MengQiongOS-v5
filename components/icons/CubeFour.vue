<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m15.34 9-8.66 5v20l8.66 5L24 44l8.66-5 8.66-5V14l-8.66-5L24 4l-8.66 5ZM24 24l-10.392 6M24 24V11v13Zm0 0 10.392 6L24 24Z"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M26.815 35.375 24 37l-2.814-1.625m11.258-19.5 2.814 1.625v3.25m-22.516 0V17.5l2.814-1.625"/></g>
  </svg>
</template>
...
export default class CubeFour extends Vue.with(Props) {
