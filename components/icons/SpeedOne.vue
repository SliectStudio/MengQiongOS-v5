<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#000" d="M30.297 18.779s-3.23 9.102-4.764 10.691a4 4 0 0 1-5.754-5.557c1.534-1.59 10.518-5.134 10.518-5.134Z"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="M38.85 38.85A20.941 20.941 0 0 0 45 24c0-11.598-9.402-21-21-21S3 12.402 3 24c0 5.799 2.35 11.049 6.15 14.85M24 4v4m14.845 3.142-3.108 2.517m6.785 13.574-3.897-.9m-33.148.9 3.898-.9m-.22-15.191 3.108 2.517"/></g>
  </svg>
</template>
...
export default class SpeedOne extends Vue.with(Props) {
