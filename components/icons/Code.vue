<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M16 13 4 25.432 16 37m16-24 12 12.432L32 37"/><path stroke-linecap="round" stroke-width="4" stroke="#fff" d="m28 4-7 40"/></g>
  </svg>
</template>
...
export default class Code extends Vue.with(Props) {
