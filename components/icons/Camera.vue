<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="m15 12 3-6h12l3 6H15Z"/><rect stroke-linejoin="round" stroke-width="4" stroke="#fff" rx="3" height="30" width="40" y="12" x="4"/><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M24 35a8 8 0 1 0 0-16 8 8 0 0 0 0 16Z"/></g>
  </svg>
</template>
...
export default class Camera extends Vue.with(Props) {
