<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M44 29H4v13h40V29Z"/><path fill="#fff" d="M35.5 38a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M4 29 9.038 4.999H39.02l4.98 24"/></g>
  </svg>
</template>
...
export default class HardDisk extends Vue.with(Props) {
