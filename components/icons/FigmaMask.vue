<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><circle stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" r="20" cy="24" cx="24"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M14 41.324C19.978 37.866 24 31.403 24 24c0-7.403-4.022-13.866-10-17.324C8.022 10.134 4 16.597 4 24c0 7.403 4.022 13.866 10 17.324Z"/></g>
  </svg>
</template>
...
export default class FigmaMask extends Vue.with(Props) {
