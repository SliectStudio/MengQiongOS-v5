<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-width="4" stroke="#fff" d="M15.417 10.5C18.237 7.7 21.942 6 26 6c8.837 0 16 8.059 16 18s-7.163 18-16 18c-4.058 0-7.763-1.7-10.583-4.5"/><rect stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" rx="2" height="28" width="10" y="10" x="6"/><rect fill="#fff" transform="rotate(90 13 18)" rx="2" height="4" width="4" y="18" x="13"/><rect fill="#fff" transform="rotate(90 13 25)" rx="2" height="4" width="4" y="25" x="13"/></g>
  </svg>
</template>
...
export default class IwatchTwo extends Vue.with(Props) {
