<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><rect stroke-width="4" stroke="#fff" rx="3" height="40" width="26" y="4" x="11"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M22 10h4m-6 28h8"/></g>
  </svg>
</template>
...
export default class Iphone extends Vue.with(Props) {
