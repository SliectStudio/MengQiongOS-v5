<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="M24.008 33.9V6M36 22 24 34 12 22m24 20H12"/></g>
  </svg>
</template>
...
export default class ToBottom extends Vue.with(Props) {
