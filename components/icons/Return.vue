<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m13 8-7 6 7 7"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="M6 14h22.994c6.883 0 12.728 5.62 12.996 12.5.284 7.27-5.723 13.5-12.996 13.5H11.998"/></g>
  </svg>
</template>
...
export default class Return extends Vue.with(Props) {
