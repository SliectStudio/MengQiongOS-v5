<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path fill-opacity=".01" fill="#fff" d="M0 0h48v48H0z"/><path stroke-linejoin="round" stroke-width="4" stroke="#fff" d="M11 42a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm26 0a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z"/><path stroke-linecap="round" stroke-width="4" stroke="#fff" d="m15.377 39.413 2.123-3.597 17-29.445"/><path stroke-linecap="round" stroke-width="4" stroke="#fff" d="m13.496 6.175 17 29.445 2.13 3.793"/></g>
  </svg>
</template>
...
export default class CuttingOne extends Vue.with(Props) {
