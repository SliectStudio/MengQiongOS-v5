<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-width="4" stroke="#000" d="M5 8a2 2 0 0 1 2-2h12l5 6h17a2 2 0 0 1 2 2v26a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8Z"/><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="m24 20 2.243 4.913 5.366.615-3.98 3.651 1.073 5.293L24 31.816l-4.702 2.656 1.073-5.293-3.98-3.651 5.366-.615L24 20Z"/></g>
  </svg>
</template>
...
export default class FolderFocus extends Vue.with(Props) {
