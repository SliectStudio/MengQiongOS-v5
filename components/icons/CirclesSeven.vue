<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#000" d="M24 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm0 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm10.392-10a4 4 0 1 0 6.929-4 4 4 0 0 0-6.928 4Zm0 12a4 4 0 1 0 6.929 4 4 4 0 0 0-6.928-4ZM24 36a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-10.392-6a4 4 0 1 0-6.928 4 4 4 0 0 0 6.928-4Zm0-12a4 4 0 1 0-6.928-4 4 4 0 0 0 6.928 4Z" clip-rule="evenodd"/></g>
  </svg>
</template>
...
export default class CirclesSeven extends Vue.with(Props) {
