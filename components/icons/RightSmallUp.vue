<template>
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    ref="host"
  >
    <g><path stroke-linejoin="round" stroke-linecap="round" stroke-width="4" stroke="#fff" d="m16 32 17-17m-18 0h18v18"/></g>
  </svg>
</template>
...
export default class RightSmallUp extends Vue.with(Props) {
